        ...
        <tr>
            <td align="center" style="width: 963px; height: 513px;">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td style="height: 16px">
                            <img src="images/登陆页面.jpg" width="980" height="200" alt="" />
                        </td>
                    </tr>
                </table>
                <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF">
                    <tr>
                        <td>
                            <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolordark="#000000"
                                bordercolorlight="#FFFFFF" style="height: 202px">
                                <tr>
                                <td width="200">
                                    <div align="center">
                                ...
                                <td width="122" align="center">
                                    <asp:RadioButtonList ID="rblUserID" runat="server" RepeatDirection="Horizontal" AutoPostBack="True"
                                        OnSelectedIndexChanged="rblUserID_SelectedIndexChanged">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" align="left">
                                        <asp:TextBox ID="txtPwd" runat="server" MaxLength="12" TextMode="Password" Height="25"
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="width: 62px; height: 30px;">
                                        &nbsp;
                                    </td>
                                </tr>
                                <%--  <tr>
                                    ...
                                    <td align="left" style="width: 277px; height: 20px;">
                                        <asp:TextBox ID="txtCode" runat="server" Height="25px" Width="112px"></asp:TextBox>
                                    </td>
                                    <td align="center" style="height: 20px">
                                        <asp:Image ID="Image1" runat="server" Width="100px" BorderColor="Gray" BorderWidth="1px"
                                            Height="32px" ImageUrl="Image.aspx" />
                                    </td>
                                    <td align="center" style="height: 20px">
